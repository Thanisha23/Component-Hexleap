    ...
    <div className="bg-[#F7F7F8] dark:bg-[#292B32]">
      <div className="py-[5rem] px-[3rem] md:px-[9rem]">
        ...
        <div className="flex justify-center items-center">
          <div className="pt-[25px] grid grid-cols-1 sm:grid-cols-2 sm:gap-[14.09px]  lg:grid-cols-5 lg:gap-[14.09px] md:grid-cols-3 md:gap-[14.09px] gap-[14.09px]">
            {cardData.map((data) => (
              <Card
                key={data.id}
                image={data.image}
        ...
        <div className="mt-[53px] bg-[#F9F8FF] dark:bg-gradient-to-t from-[#221A2C] to-[#18282A] md::w-[1240px] md::h-[900px] pt-[70px] pb-[49px] px-0 md:px-[78px]">
          ...
          >
            <div>
              ...
              {/* cards */}
              <div className="flex justify-center items-center">
              <div className="pt-[51px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[36px]">
